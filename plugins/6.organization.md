> This page location: Auth > Plugins > Supported plugins > Organization
...
You can also configure the plugin via the [Neon API](https://neon.com/docs/reference/api). Use your API key in the `Authorization` header.
...
- [Get all plugin configurations](https://neon.com/docs/reference/api/auth/get-neon-auth-plugin-configs)
- [Update organization plugin configuration](https://neon.com/docs/reference/api/auth/update-neon-auth-organization-plugin)
...
Check the [Managed Better Auth roadmap](https://neon.com/docs/auth/roadmap) for updates on these features.
